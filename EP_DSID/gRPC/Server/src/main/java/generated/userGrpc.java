...
public final class userGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<generated.Polynome,
      generated.Polynome> getPolynomeDerivativeMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "PolynomeDerivative",
      requestType = generated.Polynome.class,
      responseType = generated.Polynome.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<generated.Polynome,
      generated.Polynome> getPolynomeDerivativeMethod() {
    io.grpc.MethodDescriptor<generated.Polynome, generated.Polynome> getPolynomeDerivativeMethod;
    if ((getPolynomeDerivativeMethod = userGrpc.getPolynomeDerivativeMethod) == null) {
      synchronized (userGrpc.class) {
        if ((getPolynomeDerivativeMethod = userGrpc.getPolynomeDerivativeMethod) == null) {
          userGrpc.getPolynomeDerivativeMethod = getPolynomeDerivativeMethod = 
              io.grpc.MethodDescriptor.<generated.Polynome, generated.Polynome>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "proto.user", "PolynomeDerivative"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  generated.Polynome.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  generated.Polynome.getDefaultInstance()))
                  .setSchemaDescriptor(new userMethodDescriptorSupplier("PolynomeDerivative"))
                  .build();
          }
        }
     }
     return getPolynomeDerivativeMethod;
  }

  private static volatile io.grpc.MethodDescriptor<generated.Empty,
      generated.Empty> getTerminateMethod;
  ...
  public static io.grpc.MethodDescriptor<generated.Empty,
      generated.Empty> getTerminateMethod() {
    io.grpc.MethodDescriptor<generated.Empty, generated.Empty> getTerminateMethod;
    if ((getTerminateMethod = userGrpc.getTerminateMethod) == null) {
      synchronized (userGrpc.class) {
        if ((getTerminateMethod = userGrpc.getTerminateMethod) == null) {
          userGrpc.getTerminateMethod = getTerminateMethod = 
              io.grpc.MethodDescriptor.<generated.Empty, generated.Empty>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "proto.user", "Terminate"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  generated.Empty.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  generated.Empty.getDefaultInstance()))
                  .setSchemaDescriptor(new userMethodDescriptorSupplier("Terminate"))
                  .build();
          }
        }
     }
  ...
  public static abstract class userImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void polynomeDerivative(generated.Polynome request,
        io.grpc.stub.StreamObserver<generated.Polynome> responseObserver) {
      asyncUnimplementedUnaryCall(getPolynomeDerivativeMethod(), responseObserver);
    }

    /**
     */
    public void terminate(generated.Empty request,
        io.grpc.stub.StreamObserver<generated.Empty> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          ...
          .addMethod(
            getPolynomeDerivativeMethod(),
            asyncUnaryCall(
              new MethodHandlers<
                generated.Polynome,
                generated.Polynome>(
                  this, METHODID_POLYNOME_DERIVATIVE)))
          .addMethod(
            getTerminateMethod(),
            asyncUnaryCall(
              new MethodHandlers<
  ...
  public static final class userStub extends io.grpc.stub.AbstractStub<userStub> {
    ...
    public void polynomeDerivative(generated.Polynome request,
        io.grpc.stub.StreamObserver<generated.Polynome> responseObserver) {
      asyncUnaryCall(
          getChannel().newCall(getPolynomeDerivativeMethod(), getCallOptions()), request, responseObserver);
    }
  ...
  public static final class userBlockingStub extends io.grpc.stub.AbstractStub<userBlockingStub> {
    ...
    /**
     */
    public generated.Polynome polynomeDerivative(generated.Polynome request) {
      return blockingUnaryCall(
          getChannel(), getPolynomeDerivativeMethod(), getCallOptions(), request);
    }

    /**
     */
    public generated.Empty terminate(generated.Empty request) {
      return blockingUnaryCall(
  ...
  public static final class userFutureStub extends io.grpc.stub.AbstractStub<userFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<generated.Polynome> polynomeDerivative(
        generated.Polynome request) {
      return futureUnaryCall(
          getChannel().newCall(getPolynomeDerivativeMethod(), getCallOptions()), request);
    }

    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<generated.Empty> terminate(
        generated.Empty request) {
      return futureUnaryCall(
  ...
  private static final int METHODID_POLYNOME_DERIVATIVE = 5;
      ...
      switch (methodId) {
        ...
        case METHODID_THIRD_DEGREE_SOLVE:
          serviceImpl.thirdDegreeSolve((generated.Polynome) request,
              (io.grpc.stub.StreamObserver<generated.ThirdDegreeRoot>) responseObserver);
          break;
        case METHODID_POLYNOME_DERIVATIVE:
          serviceImpl.polynomeDerivative((generated.Polynome) request,
              (io.grpc.stub.StreamObserver<generated.Polynome>) responseObserver);
          break;
        case METHODID_TERMINATE:
          serviceImpl.terminate((generated.Empty) request,
              (io.grpc.stub.StreamObserver<generated.Empty>) responseObserver);
          break;
        default:
      ...
      synchronized (userGrpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              ...
              .addMethod(getPolynomeDerivativeMethod())
